            ...
            public void onClick(View v) {
                new AsyncTask<Void, Void, Void>(){
                    ...
                    protected Void doInBackground(Void... params) {
                        String headline = ((EditText)findViewById(R.id.headline)).getText().toString();
                        String costStr = ((EditText)findViewById(R.id.cost)).getText().toString();
                        String durationStr = ((EditText)findViewById(R.id.duration)).getText().toString();
                        String description = ((EditText)findViewById(R.id.description)).getText().toString();
                        String locationX = ((EditText)findViewById(R.id.locationX)).getText().toString();
                        String locationY = ((EditText)findViewById(R.id.locationY)).getText().toString();
